...
const Featured = () => {
    // Select top 6 featured products
    const featuredProducts = COLLECTION_PRODUCTS.slice(0, 6);

    return (
        <section className="w-full py-16 px-6 md:px-12 bg-white text-zinc-900 dark:bg-black dark:text-white transition-colors duration-300">
